...
enum Token {
	...
	LT,GT,LE,GE,EQ,NE,
	LOG_AND,LOG_OR,
	ASSIGN,LET_ASSIGN,DECLARE_WITH_TYPE,PATTERN_BIND,FIELD_ASSIGN,
	...
	NEG,DEREF,ADDR,NOT,COMPLEMENET, MAYBE_PTR,OWN_PTR,MAYBE_REF,VECTOR_OF,SLICE,SLICE_REF,DOUBLE_QUESTION_MARK,TAG_QUESTION_MARK,TAG_MUL,TAG_ADD,TAG_SUB,TAG_DIV, MAYBE_ARROW,
	...
	IDENT,
	EXTERN_C,__VTABLE_PTR,__DATA_PTR,__PARENT_PTR,__ENV_PTR,__DISCRIMINANT, __ENV_I8_PTR,NUM_STRINGS
};
